...
{
  return _op == af._op &&_left == af._left 
          && _right == af._right &&  _tag == af._tag;
}
...
// for synthesis
void
aalta_formula::to_set (std::unordered_set<int>& edge)
{
